...
2. Then, go to the directory `pinata-nextjs` in the terminal, run `pip install spacy`, then run `npm run dev`, you should be able to see the page at http://localhost:3000/
